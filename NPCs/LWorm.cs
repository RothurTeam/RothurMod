...
{
	internal class LunarWormHead : LunarWorm
	{
	...
	internal class LunarWormBody : LunarWorm
	{
	...
	internal class LunarWormTail : LunarWorm
	{
	...
	public abstract class LunarWorm : LWorm
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Nature Eater");
			DisplayName.AddTranslation(GameCulture.Russian, "Лунный пожиратель");
		}

		public override void Init() {
			minLength = 12;
			maxLength = 12;
			tailType = NPCType<LunarWormTail>();
			bodyType = NPCType<LunarWormBody>();
			headType = NPCType<LunarWormHead>();
			speed = 6f;
			turnSpeed = 0.05f;
			npc.damage = 30;
			//npc.boss = true;
	...
	public abstract class LWorm : ModNPC
	{
		/* ai[0] = follower
		 * ai[1] = following
