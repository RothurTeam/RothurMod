...
namespace RothurMod.Items
{
	...
	public class ExampleStatueItem : ModItem
	{
		public override void SetStaticDefaults() {
			...
			DisplayName.AddTranslation(GameCulture.Russian, "Статуя золотой рыбки");
		}
	...
	public class ExampleStatueModWorld : ModWorld
	{
		public override void ModifyWorldGenTasks(List<GenPass> tasks, ref float totalWeight) {
			...
			if (ResetIndex != -1) {
				tasks.Insert(ResetIndex + 1, new PassLegacy("Rothur Mod Statue Setup", delegate (GenerationProgress progress) {
					progress.Message = "Adding RothurMod Statue";
					...
					Array.Resize(ref WorldGen.statueList, WorldGen.statueList.Length + 2);
