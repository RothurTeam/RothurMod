...
namespace RothurMod.Items
{
	...
	public class ExampleDashAccessory : ModItem
	{
		public override void SetStaticDefaults()
		{
			...
			DisplayName.SetDefault("Balance Boot");
			DisplayName.AddTranslation(GameCulture.Russian, "Ботинки баланса");
			Tooltip.AddTranslation(GameCulture.Russian, "" +
				"\nДвойное движение позволяет сделать вам рывок вперед");
		}
		...
		public override void AddRecipes()
		{
			...
			recipe.AddIngredient(ItemType<Balance>(), 1);
