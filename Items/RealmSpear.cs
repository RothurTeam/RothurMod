...
{
	public class RealmSpear : ModItem
	{
		public override void SetStaticDefaults() 
		{ 
			Tooltip.SetDefault("");
			DisplayName.AddTranslation(GameCulture.Russian, "Реалмитовое копье");
		...
		public override void SetDefaults() {
			...
			item.shoot = ProjectileType<RealmSpearProjectile>();
		}
		
		public override void AddRecipes() 
		{
			ModRecipe recipe = new ModRecipe(mod);
			recipe.AddIngredient(null, "RealmShard", 3);
