 ...
 * This is NOT an in-depth guide to advanced minion AI
	...
	public class EMinionBuff : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			if (player.ownedProjectileCounts[ProjectileType<EMinion>()] > 0) {
	...
	public class EMinionItem : ModItem
	{
		...
		public override void SetDefaults() {
			...
			item.noMelee = true;
			item.summon = true;
			item.buffType = BuffType<EMinionBuff>();
			// No buffTime because otherwise the item tooltip would say something like "1 minute duration"
			item.shoot = ProjectileType<EMinion>();
		}
	 ...
	 */
	public class EMinion : ModProjectile
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Grim follower");
			DisplayName.AddTranslation(GameCulture.Russian, "Мрачный последователь");
		...
		public override void AI() {
			...
			if (player.dead || !player.active) {
				player.ClearBuff(BuffType<EMinionBuff>());
			}
			if (player.HasBuff(BuffType<EMinionBuff>())) {
