...
namespace RothurMod.Items.Weapons
{
	public class EmeraldYoYo : ModItem
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Emerald Yo Yo"); 
			Tooltip.SetDefault("");
			DisplayName.AddTranslation(GameCulture.Russian, "Изумрудное йо йо");
		...
		public override void SetDefaults() {
			...
			item.shoot = ProjectileType<EmeraldYoYoProjectile>();
		}
		...
		public override void AddRecipes() {
			...
			recipe.AddIngredient(ItemID.Emerald, 9);
