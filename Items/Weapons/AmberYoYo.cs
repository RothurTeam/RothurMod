...
namespace RothurMod.Items.Weapons
{
	public class AmberYoYo : ModItem
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Amber Yo Yo"); 
			Tooltip.SetDefault("");
			DisplayName.AddTranslation(GameCulture.Russian, "Янтарное йо йо");
		...
		public override void SetDefaults() {
			...
			item.shoot = ProjectileType<AmberYoYoProjectile>();
		}
		...
		public override void AddRecipes() {
			...
			recipe.AddIngredient(ItemID.Amber, 9);
