...
{
	internal class HookItem : ModItem
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("The hook of despair");
			DisplayName.AddTranslation(GameCulture.Russian, "Крюк отчаяния");
		}
		...
		public override void SetDefaults() {
			...
			*/
			...
			item.shoot = ProjectileType<HookProjectile>();
			item.rare = 1;
		}
	...
	internal class HookProjectile : ModProjectile
	{
		public override void SetStaticDefaults() {
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor) {
			...
			while (distance > 30f && !float.IsNaN(distance)) {
				...
				//Draw chain
				spriteBatch.Draw(mod.GetTexture("Items/HookChain"), new Vector2(center.X - Main.screenPosition.X, center.Y - Main.screenPosition.Y),
