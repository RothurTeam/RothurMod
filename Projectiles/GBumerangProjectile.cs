...
{
	public class GBumerangProjectile : ModProjectile
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Bumerang");     //The English name of the projectile
		...
		public override void SetDefaults() {
			...
			projectile.hostile = false;         //Can the projectile deal damage to the pla
			...
			aiType = ProjectileID.EnchantedBoomerang;           //Act exactly like default Bullet
		}
