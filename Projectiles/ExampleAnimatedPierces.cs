...
namespace RothurMod.Projectiles
{
	...
	*/
	...
	internal class ExampleAnimatedPierces : ModProjectile
	{
	...
	internal class ExamplesPierce : ModItem
	{

		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Holy glove");
		...
		public override void SetDefaults() {
			...
			item.shoot = 10;
			item.shootSpeed = 10f;
			item.shoot = ProjectileType<ExampleAnimatedPierces>();
		}
