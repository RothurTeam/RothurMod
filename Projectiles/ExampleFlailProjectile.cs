...
namespace RothurMod.Projectiles
{
	public class ExampleFlailProjectile : ModProjectile
	{
		...
		private const string ChainTexturePath = "RothurMod/Projectiles/ExampleFlailProjectileChain";

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Flail Ball"); // Set the projectile name to Example Flail Ball
		}
