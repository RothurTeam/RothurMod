...
{
    public class BoneFloat : ModProjectile
    {
        ...
        public override bool PreDrawExtras(SpriteBatch spriteBatch)      //this draws the fishing line correctly
        {
            ...
            if (projectile.bobber && Main.player[projectile.owner].inventory[Main.player[projectile.owner].selectedItem].holdStyle > 0)
            {
                ...
                if (type == mod.ItemType("BoneFishingPole")) //add your Fishing Pole name here
                {
                ...
                while (flag2)
                {
                    ...
                    else
                    {
                        ...
                        Microsoft.Xna.Framework.Color color2 = Lighting.GetColor((int)value.X / 16, (int)(value.Y / 16f), new Microsoft.Xna.Framework.Color(238, 232, 170));    //this is the fishing line color in RGB, 200 is red, 12 is green, 50 blue
