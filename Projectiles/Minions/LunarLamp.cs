...
namespace RothurMod.Projectiles.Minions
{
	...
	public class LunarLamp : HoverShooter
	{
		...
		public override void CreateDust() {
			if (projectile.ai[0] == 0f) {
				if (Main.rand.NextBool(5)) {
					int dust = Dust.NewDust(projectile.position, projectile.width, projectile.height / 2, DustType<LunarFlame>());
				...
				if (Main.rand.NextBool(3)) {
					...
					int dust = Dust.NewDust(projectile.position, projectile.width, projectile.height, DustType<LunarFlame>());
